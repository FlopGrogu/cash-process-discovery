...
class HeuristicsMiner(DiscoveryAlgorithm):
    algorithm_name = "heuristics_miner"
    backend_name = "pm4py"
    ...
    def discover(self, train_log: Any, config: dict[str, Any]) -> DiscoveryResult:
        ...
        try:
            ...
            payload = discover_heuristics_miner(train_log, config)
...
def _failure_metadata(
    *,
    ...
    return {
        "algorithm_name": HeuristicsMiner.algorithm_name,
        "backend": HeuristicsMiner.backend_name,
