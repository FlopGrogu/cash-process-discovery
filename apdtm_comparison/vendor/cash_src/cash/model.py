...
# Union of tuning hyperparameters across all algorithm variants (v5 included).
# Most are NaN for a given algorithm/variant and get set a to default value downstream.
ALL_HYPER_NAMES = [
    # heuristic miner
    "and_threshold",
...
# There is deliberately no hardcoded algorithm list -- the algorithms the
...
# Backwards-compatible alias (eval.py still imports WEIGHTS).
